    ...
    <nav class="navbar top-navbar navbar-expand-md">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                ...
                Time:<b><span class="jam ml-2" style="width:60px; margin-left:5px;"></span></b>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        {{-- <div class="dropdown-divider"></div>
                                <div class="pl-4 p-3"><a href="{{ route('change.password') }}" class="btn btn-sm btn-info">View Profile</a>
                    </div> --}}
                    <a class="dropdown-item" href="/viewprofile"><i data-feather="user" class="svg-icon mr-2 ml-1"></i>
                        My Profile</a>
                    ...
                    {{-- <div class="dropdown-divider"></div>
                                <div class="pl-4 p-3"><a href="{{ route('change.password') }}" class="btn btn-sm btn-info">Change Password</a>
        </div> --}}
        </div>
        </li>
        <!-- ============================================================== -->
