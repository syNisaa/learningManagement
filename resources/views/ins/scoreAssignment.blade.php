    ...
    <div class="container">
        ...
        <div class="modal" tabindex="-1" id="modalNilai{{ $a->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Score - {{$a->subject_matter}} </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="/ass/update/{{$a->id}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="hidden" value="{{$a->class_category}}" name="class" id="class" class="form-control" placeholder="Subject Matter" aria-label="class" aria-describedby="basic-addon1">
                            </div>
