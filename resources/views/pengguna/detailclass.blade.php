        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 mr-lg-auto mt-lg-5 col-12" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <font face="comic MS sans" size="6">{{$c->category}} <small>|<b> {{$c->price}}</b></small></font><br><br>

                    <font face="times new roman" size="4" class="mt-4 mb-4">{{$c->deskripsi}}</font>
                    ...
                    <form id="form-bayar" method="post">
                        ...
                        <center><br><br>
                            ...
                            <a href="/homestudent" type="button" class="btn btn-outline-secondary">Back</a>
                        </center>
                    </form>
